...
<g id="external-/-24-/-dark" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    */
export default function iconLink(_ref) {
  var svg = _ref.svg,
      _ref$x = _ref.x,
      x = _ref$x === void 0 ? 5 : _ref$x,
      _ref$y = _ref.y,
      y = _ref$y === void 0 ? 5 : _ref$y;
  var container = svg.append('g').attr('stroke', 'none').attr('fill', 'none').style('cursor', 'pointer').append('g');
  var icon = container.append('g').attr('id', 'icon').attr('fill', '#92a0ad').attr('transform', "translate(".concat(x, ", ").concat(y, ")"));
